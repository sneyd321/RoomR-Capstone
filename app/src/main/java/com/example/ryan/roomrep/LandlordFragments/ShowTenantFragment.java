...
public class ShowTenantFragment extends Fragment {
...
//        rcyTenantProfile.setAdapter(adapter);
    ...
    public  View.OnClickListener onNavigateToGroupChat = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            infTeant.clear();
            if(tenantRouterActionListen != null){
                tenantRouterActionListen.onNavigateToMessages();
            }
        }
    };
    ...
    public void setRouterAction(TenantRouterAction routerActionListenerTenant) {
        this.tenantRouterActionListen = routerActionListenerTenant;
    }
