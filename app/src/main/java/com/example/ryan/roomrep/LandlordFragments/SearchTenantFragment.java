...
//        });
    ...
    public void onItemClick(View view, int position) {
        if (routerActionListener != null) {
            ((MainActivityLandlord)getActivity()).peopleToAdd = new Tenant(profiles.get(position).getFirstName(),profiles.get(position).getLastName(),"LOL@GMAIL.COM","123456","123456","FINALMAKE IT", "","5.0");
